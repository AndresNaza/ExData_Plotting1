...
### Set graphical parameter to show matrix of plots

par(mfrow=c(2,2))


### Create plot nro 1/4 on screen device
...
### Create plot nro 2/4 on screen device

plot(household_power_consumption_Feb$date_time,household_power_consumption_Feb$Voltage,
     type = "l",
     ylab = "Voltage",
     xlab = "datetime")
...
### Create plot nro 3/4 on screen device
...
### Create plot nro 4/4 on screen device

plot(household_power_consumption_Feb$date_time,household_power_consumption_Feb$Global_reactive_power,
     type = "l",
